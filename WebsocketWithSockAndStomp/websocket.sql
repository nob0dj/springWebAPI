...
Insert into SPRING.MEMBER (MEMBERID,PASSWORD,MEMBERNAME,GENDER,AGE,EMAIL,PHONE,ADDRESS,HOBBY,ENROLLDATE) values ('test','1234','테스트','F',10,'tester@email.com','01012341234',null,'운동,등산',to_date('12-05-18','DD-MM-RR'));
