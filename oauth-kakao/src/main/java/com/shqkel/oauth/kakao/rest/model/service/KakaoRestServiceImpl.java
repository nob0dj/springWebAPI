...
public class KakaoRestServiceImpl implements KakaoRestService {
	...
	public static final String KAKAO_RESTAPI_KEY = "d1b48dc4750808a98c7d2bcaee092f5f";
	private static final String KAKAO_REDIRECT_URL = "http://localhost:9090/oauth-kakao/rest/redirect";
	...
	public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            // POST 요청을 위해 기본값이 false인 setDoOutput을 true처리
            conn.setRequestMethod("POST");
            conn.setDoOutput(true); //출력전용
            
            // POST 요청에 필요로 요구하는 파라미터 스트림을 통해 전송
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(conn.getOutputStream()));
            StringBuilder sb = new StringBuilder();
            sb.append("grant_type=authorization_code");
            sb.append("&client_id=" + KAKAO_RESTAPI_KEY);
